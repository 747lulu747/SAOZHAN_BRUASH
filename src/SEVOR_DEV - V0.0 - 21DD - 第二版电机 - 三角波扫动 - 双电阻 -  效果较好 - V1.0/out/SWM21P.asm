...
** ELF Header Information
    ...
    File Name: D:\凯创得\扫动牙刷\src\SEVOR_DEV - V0.0 - 21DD - 第二版电机 - 三角波扫动 - 双电阻 -  效果较好 - V1.0\out\SWM21P.axf
    ...
    Program header offset: 419440 (0x00066670)
    Section header offset: 419472 (0x00066690)
...
** Section #1 'ER_IROM1' (SHT_PROGBITS) [SHF_ALLOC + SHF_EXECINSTR]
    ...
    swing_vibration_set
        ...
        0x00002bca:    4814        .H      LDR      r0,[pc,#80] ; [0x2c1c] = 0x40400000
    ...
    $d
        ...
        0x00002c1c:    40400000    ..@@    DCD    1077936128
