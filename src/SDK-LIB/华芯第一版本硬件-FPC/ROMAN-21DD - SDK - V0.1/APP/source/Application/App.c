...
#define SWING_DUTY_1                ((int32)(0.5 * SWING_AMPLITUE_UNIT))   // swing one
#define VIBRATION_FRE_1             (220)
#define VIBRATION_DUTY_1            (_Q15(0.30))

#define SWING_FRE_2                 (5)  
#define SWING_DUTY_2                ((int32)(0.75 * SWING_AMPLITUE_UNIT))
#define VIBRATION_FRE_2             (220)
#define VIBRATION_DUTY_2            (_Q15(0.30))

#define SWING_FRE_3                 (7)  
#define SWING_DUTY_3                ((int32)(1.0 * SWING_AMPLITUE_UNIT))
#define VIBRATION_FRE_3             (220)
#define VIBRATION_DUTY_3            (_Q15(0.30))

#define SWING_FRE_4                 (3.0)  
#define SWING_DUTY_4                ((int32)(0.7 * SWING_AMPLITUE_UNIT))
#define VIBRATION_FRE_4             (550)
#define VIBRATION_DUTY_4            (_Q15(0.30))

#define SWING_FRE_5                 (3.0)  
#define SWING_DUTY_5                ((int32)(0.7 * SWING_AMPLITUE_UNIT))
#define VIBRATION_FRE_5             (750)
...
void app_init(void) {
  ...
  button = last_button = BUTTON_INPUT;
  #endif
