...
#define DEMO_MOTOR_1
#ifdef DEMO_MOTOR_1
#define SV_CFG_DEF_LH0_ADC_OFFSET               ((17459 + 13917)/2)
#define SV_CFG_DEF_LH1_ADC_OFFSET               ((17348 + 13966)/2)
#define SV_CFG_DEF_ZERO_M_THETA                 (12760)
#define SV_CFG_DEF_SWING_BASE_M_THETA           (89600)
#define APP_BUTTON_PORT                         (GPIOM)
#define APP_BUTTON_PIN                          (PIN9)
#define BUTTON_INPUT                            (GPIO_GetBit(APP_BUTTON_PORT, APP_BUTTON_PIN))
#endif

// #define SV_CFG_DEF_LH0_ADC_OFFSET               (15604 + 361)
// #define SV_CFG_DEF_LH1_ADC_OFFSET               (15652 + 240)

// #define SV_CFG_DEF_ZERO_M_THETA                 (55554)
// #define SV_CFG_DEF_SWING_BASE_M_THETA           (72240)

// #define SV_CFG_DEF_ZERO_M_THETA                 (72000)
// #define SV_CFG_DEF_SWING_BASE_M_THETA           (87860)
