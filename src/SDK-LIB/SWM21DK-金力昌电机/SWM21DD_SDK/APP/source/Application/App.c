...
// Macro define
#define SW_SPEED                    (3.2)
#define SW_ANGLE_1                  ((int32)(0.2 * SWING_AMPLITUE_UNIT))
#define SW_ANGLE_2                  ((int32)(0.4 * SWING_AMPLITUE_UNIT))
#define SW_ANGLE_3                  ((int32)(0.6 * SWING_AMPLITUE_UNIT))
#define LOW_VIBRATION_DUTY_1        (_Q15(0.25))
#define LOW_VIBRATION_DUTY_2        (_Q15(0.30))
#define LOW_VIBRATION_DUTY_3        (_Q15(0.35))
...
#define VIBRATION_FRE_1             (LOW_FREQ)
#define VIBRATION_DUTY_1            (LOW_VIBRATION_DUTY_1)

#define SWING_FRE_2                 (SW_SPEED)  
#define SWING_DUTY_2                (SW_ANGLE_2)
#define VIBRATION_FRE_2             (LOW_FREQ)
#define VIBRATION_DUTY_2            (LOW_VIBRATION_DUTY_2)

#define SWING_FRE_3                 (SW_SPEED)  
#define SWING_DUTY_3                (SW_ANGLE_3)
#define VIBRATION_FRE_3             (LOW_FREQ)
#define VIBRATION_DUTY_3            (LOW_VIBRATION_DUTY_3)
...
#define SWING_FRE_7                 (0.35)  
#define SWING_DUTY_7                ((int32)(1.0 * SWING_AMPLITUE_UNIT))
#define VIBRATION_FRE_7             (220)
#define VIBRATION_DUTY_7            (LOW_VIBRATION_DUTY_3)
...
void app_init(void) {
  ...
  GPIO_Init(APP_BUTTON_PORT, APP_BUTTON_PIN, input, no_pull_up, no_pull_up, 0);
  button_pin = last_button_pin = BUTTON_INPUT;
  #endif

  // GPIO_Init(GPIOB, PIN10, output, pull_up, no_pull_up, 0);
  // GPIO_SetBit(GPIOB, PIN10);
...
int zero_m_theta_align_proc(void) {
  ...
  switch (phase)
  {
    ...
    {
      // duty suggest set to _Q15(0.4) ~ _Q15(0.7)
      ret = foc_core_set_zero_m_theta_align_mode(_Q15(0.3));
      if (0 != ret) {
...
void button_proc(void) {
...

  {
    switch (app_ctrl_state)
    {
      ...
      {
        foc_core_set_sv(SWING_FRE_1, SWING_DUTY_1, VIBRATION_FRE_1, VIBRATION_DUTY_1);
        // foc_core_set_sv(SWING_FRE_7, SWING_DUTY_7, VIBRATION_FRE_7, 0);
      }
      break;
      ...
      // case APP_CTRL_WORK_7:
      // {
      //   foc_core_set_sv(SWING_FRE_7, SWING_DUTY_7, VIBRATION_FRE_7, VIBRATION_DUTY_7);
      // }
      // break;
