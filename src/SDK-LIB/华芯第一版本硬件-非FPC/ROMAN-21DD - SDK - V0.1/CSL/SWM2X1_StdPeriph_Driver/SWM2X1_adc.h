...
/*  ADC_CLKSRC_中的分频值4、8、16、32、64、128由下面三级硬件分频合并而来：
	第一级、SYS->CLKSEL.ADC寄存器域选择时钟源时自带1、4、8可配置分频
	第二级、ADC模块对选中时钟源固定4分频
	第三级、ADC->CTRL3.CLKDIV1寄存器域可配置1、2、4分频
*/
...
#define ADC_TRIGGER_SW			4	//软件触发，即ADC->START.GO写1启动转换
