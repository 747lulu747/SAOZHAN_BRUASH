...
#define VIBRATION_DUTY_1            (_Q15(0.35))

#define SWING_FRE_2                 (4.5)  
#define SWING_DUTY_2                ((int32)(0.5 * SWING_AMPLITUE_UNIT))
#define VIBRATION_FRE_2             (220)
#define VIBRATION_DUTY_2            (_Q15(0.35))

#define SWING_FRE_3                 (7.18)  
#define SWING_DUTY_3                ((int32)(0.7 * SWING_AMPLITUE_UNIT))
#define VIBRATION_FRE_3             (220)
#define VIBRATION_DUTY_3            (_Q15(0.35))

#define SWING_FRE_4                 (3.18)  
#define SWING_DUTY_4                ((int32)(0.7 * SWING_AMPLITUE_UNIT))
#define VIBRATION_FRE_4             (300)
#define VIBRATION_DUTY_4            (_Q15(0.30))

#define SWING_FRE_5                 (5.5)  
#define SWING_DUTY_5                ((int32)(0.3 * SWING_AMPLITUE_UNIT))
