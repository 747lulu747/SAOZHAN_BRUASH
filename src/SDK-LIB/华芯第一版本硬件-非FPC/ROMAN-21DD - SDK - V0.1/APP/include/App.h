...
#define SV_CFG_DEF_LH0_ADC_OFFSET               (15604 + 350)
#define SV_CFG_DEF_LH1_ADC_OFFSET               (15652 + 300)

#define SV_CFG_DEF_ZERO_M_THETA                 (96772)
#define SV_CFG_DEF_SWING_BASE_M_THETA           (13114)
