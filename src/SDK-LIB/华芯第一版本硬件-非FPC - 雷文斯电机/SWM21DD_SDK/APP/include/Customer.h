...
/* ----------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------- */
#define   Pole_Pairs                    (2.0)                                     // Number of motor pole pairs
#define   RS                            (1.5 * 2.05)                        			// Stator resistance , ohm
// #define     LD                          (0.000300)                             		// D axis inductance , H
// #define     LQ                          (0.000380)                             		// Q axis inductance , H
#define     LD                          (0.000300)                             		// D axis inductance , H
#define     LQ                          (0.000415)                             		// Q axis inductance , H
#define     LS                          (1.5 * (LQ+LD) / 2.0) 
// Vpp = 3.5V, f = 9.09
// Ke = Vpp / 2 /sqrt(3) / f = 0.111154
#define     Ke                          (0.111154)
// #define     Ke                          (0.511154)
#define			Psi													(Ke / (2*3.14159)) // 0.017690
#define			GAMMA												(10)
