...
#define DEMO_MOTOR_1
#ifdef DEMO_MOTOR_1
#define SV_CFG_DEF_LH0_ADC_OFFSET               (16378)
#define SV_CFG_DEF_LH1_ADC_OFFSET               (16404)
#define SV_CFG_DEF_ZERO_M_THETA                 (55750)
#define SV_CFG_DEF_SWING_BASE_M_THETA           (72940)
#define APP_BUTTON_PORT                         (GPIOA)
#define APP_BUTTON_PIN                          (PIN14)
