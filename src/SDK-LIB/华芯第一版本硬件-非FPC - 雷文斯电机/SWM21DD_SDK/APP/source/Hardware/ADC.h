...
#define PORT_AD_VDC             PORTB   //AD_VDC
#define PIN_AD_VDC              PIN4
#define PIN_AD_VDC_ASSIGN       PORTB_PIN4_ADC0_CH8//PORTB_PIN0_ADC0_CH4

#define PORT_AD_SPD             PORTB   //SPEED
#define PIN_AD_SPD              PIN5
#define PIN_AD_SPD_ASSIGN       PORTB_PIN5_ADC0_CH7

// #define PORT_AD_LINEAR_HALL_0         PORTA
// #define PIN_AD_LINEAR_HALL_0_PIN      PIN14
// #define PIN_AD_LINEAR_HALL_0_ASSIGN   PORTA_PIN14_ADC0_CH0

#define PORT_AD_LINEAR_HALL_0         PORTB
#define PIN_AD_LINEAR_HALL_0_PIN      PIN6
#define PIN_AD_LINEAR_HALL_0_ASSIGN   PORTB_PIN6_ADC0_CH6

#define PORT_AD_LINEAR_HALL_1         PORTB
#define PIN_AD_LINEAR_HALL_1_PIN      PIN5
#define PIN_AD_LINEAR_HALL_1_ASSIGN   PORTB_PIN5_ADC0_CH7
...
#define AD_IBUS_CHANNEL         ADC_CH6       //AD channel for Ibus
#define AD7_IBUS_CHANNEL        ADC_CH3       //AD channel for Ibus

#define AD_VDC_CHANNEL          ADC_CH8       //AD channel for VDC
...
#define AD_IV_CHANNEL           ADC_CH1       //AD channel for Ib
#define AD_IW_CHANNEL           ADC_CH2       //AD channel for Ic

#define AD_LH0_CHANNEL          ADC_CH6       //AD channel for linear hall 0
#define AD_LH1_CHANNEL          ADC_CH7       //AD channel for linear hall 1

#define AD_COM_CHANNELS         (AD_IBUS_CHANNEL|AD_VDC_CHANNEL|AD_VSP_CHANNEL)
#define AD_EXTRA_CHANNELS       (AD_TEMP_CHANNEL)

#define AD_MOTOR_CHANNELS       (AD_LH0_CHANNEL | AD_LH1_CHANNEL | AD_IV_CHANNEL | AD_IW_CHANNEL | ADC_CH8)
#define AD_All_CHANNELS         (AD_MOTOR_CHANNELS | AD_IBUS_CHANNEL | AD_VDC_CHANNEL)  
