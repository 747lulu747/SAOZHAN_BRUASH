...
/************************************************************/
// Macro define
#define SW_SPEED                    (2.85)
#define SW_ANGLE_1                  ((int32)(0.2 * SWING_AMPLITUE_UNIT))
#define SW_ANGLE_2                  ((int32)(0.5 * SWING_AMPLITUE_UNIT))
#define SW_ANGLE_3                  ((int32)(0.7 * SWING_AMPLITUE_UNIT))
#define LOW_VIBRATION_DUTY_1        (_Q15(0.20))
#define LOW_VIBRATION_DUTY_2        (_Q15(0.30))
#define LOW_VIBRATION_DUTY_3        (_Q15(0.40))
