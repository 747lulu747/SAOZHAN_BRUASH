...
#define DEMO_MOTOR_1
#ifdef DEMO_MOTOR_1
#define SV_CFG_DEF_LH0_ADC_OFFSET               ((22369 + 8595)/2)
#define SV_CFG_DEF_LH1_ADC_OFFSET               ((22369 + 8993)/2)
#define SV_CFG_DEF_ZERO_M_THETA                 (32928)
#define SV_CFG_DEF_SWING_BASE_M_THETA           (50936)
#define APP_BUTTON_PORT                         (GPIOB)
#define APP_BUTTON_PIN                          (PIN11)
