...
// #define SWING_THETA_BASE                        ((uint32)(31214))
#define SWING_THETA_BASE                        ((uint32)(29214))
...
#define SWING_RIGHT_POS_Q_DUTY                  (_Q15(0.85))
#define SWING_THETA_ISO_STRIP                   (Q_CORDIC_30_DEG)
