...
#define SV_CFG_DEF_ZERO_M_THETA                 (29784)
#define SV_CFG_DEF_SWING_BASE_M_THETA           (41192)
...
#define DCDC_EN_PORT                            (GPIO3)
#define DCDC_EN_PIN                             (GPIO_Pin_15)


#define GEARS_LED_1_PORT                        (GPIO0)
#define GEARS_LED_1_PIN                         (GPIO_Pin_5)
#define GEARS_LED_2_PORT                        (GPIO0)
#define GEARS_LED_2_PIN                         (GPIO_Pin_4)
#define GEARS_LED_3_PORT                        (GPIO0)
#define GEARS_LED_3_PIN                         (GPIO_Pin_3)

#define GEARS_LED_1_ON                          GPIO_SetBits(GEARS_LED_1_PORT, GEARS_LED_1_PIN)
#define GEARS_LED_1_OFF                         GPIO_ResetBits(GEARS_LED_1_PORT, GEARS_LED_1_PIN)
#define GEARS_LED_2_ON                          GPIO_SetBits(GEARS_LED_2_PORT, GEARS_LED_2_PIN)
#define GEARS_LED_2_OFF                         GPIO_ResetBits(GEARS_LED_2_PORT, GEARS_LED_2_PIN)
#define GEARS_LED_3_ON                          GPIO_SetBits(GEARS_LED_3_PORT, GEARS_LED_3_PIN)
#define GEARS_LED_3_OFF                         GPIO_ResetBits(GEARS_LED_3_PORT, GEARS_LED_3_PIN)
