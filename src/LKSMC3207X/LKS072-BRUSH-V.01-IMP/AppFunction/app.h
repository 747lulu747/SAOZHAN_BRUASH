...
#define APP_RUN_MODE                            (APP_RUN_MODE_LOOP)
...
#define SV_CFG_DEF_LH0_ADC_OFFSET               ((6549+23845)/2)
#define SV_CFG_DEF_LH1_ADC_OFFSET               ((5592+24958)/2)

#define SV_CFG_DEF_ZERO_M_THETA                 (14140)
#define SV_CFG_DEF_SWING_BASE_M_THETA           (35266)
