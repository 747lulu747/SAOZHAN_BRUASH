...
#define PIN_AD_LINEAR_HALL_0_PIN      PIN8
#define PIN_AD_LINEAR_HALL_0_ASSIGN   PORTA_PIN8_ADC0_CH2

#define PORT_AD_LINEAR_HALL_1         PORTA
#define PIN_AD_LINEAR_HALL_1_PIN      PIN11
#define PIN_AD_LINEAR_HALL_1_ASSIGN   PORTA_PIN11_ADC0_CH1
...
#define AD_LH0_CHANNEL          ADC_CH2      //AD channel for linear hall 0
#define AD_LH1_CHANNEL          ADC_CH1       //AD channel for linear hall 1
