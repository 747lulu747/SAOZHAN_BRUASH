...
void swing_compesation_feedforward_calibration(void) {
  ...
  if (0 <= stc_cnt && stc_cnt < 30000) {
    ...
    // swing_feedforward[stc_index] = (swing_theta_compesation + swing_feedforward[stc_index])>>1;
