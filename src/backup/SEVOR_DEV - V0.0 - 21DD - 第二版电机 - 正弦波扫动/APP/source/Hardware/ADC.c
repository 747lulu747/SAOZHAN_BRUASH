...
void Init_ADC(void)
{
  ...
  Linear hall
  */
  // GPIO_Init(GPIOB, PIN4, output, no_pull_up, no_pull_down, 0);
  // GPIO_ClrBit(GPIOB, PIN4);
  ...
  ADC_initStruct.channels = AD_LH0_CHANNEL | AD_LH1_CHANNEL;
  // ADC_initStruct.channels = AD_LH0_CHANNEL | AD_LH1_CHANNEL;
  ...
  ADC_initStruct.EOC_IEn  = ADC_CH2;
