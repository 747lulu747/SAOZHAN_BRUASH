...
//								(1 << SYS_OPACR_VREFON_Pos) |			// Add by 747
//								(1 << SYS_OPACR_OPA1MD_Pos) |		  // OPA1������PGAģʽ // Change by 747
//								(0 << SYS_OPACR_OPA2MD_Pos) |		  // OPA2������PGAģʽ
//								(0 << SYS_OPACR_OPA3MD_Pos);		  // OPA3������PGAģʽ
...
//								(1 << SYS_OPACR_OPA2ON_Pos) |
//								(1 << SYS_OPACR_OPA3ON_Pos) |
//								(1 << SYS_OPACR_VREFON_Pos) |
//								(1 << SYS_OPACR_OPA1MD_Pos) |		  // OPA1������PGAģʽ
//								(1 << SYS_OPACR_OPA2MD_Pos) |		  // OPA2������PGAģʽ
//								(1 << SYS_OPACR_OPA3MD_Pos);		  // OPA3������PGAģʽ
//								
// SYS->PGACR =  (0 << SYS_OPACR_VREFON_Pos) |		// VREF��ѹ��2V
//               (0 << SYS_PGACR_OPA1GN_Pos) |		// PGA1���淴�����裺10K
//							 (0 << SYS_PGACR_OPA2GN_Pos) |
//               (0 << SYS_PGACR_OPA3GN_Pos) |		// PGA2���淴�����裺10K
//               (0 << SYS_PGACR_OPA1SW_Pos) |		// PGA1����˲����裺1K
//							 (0 << SYS_PGACR_OPA2SW_Pos) |
//               (0 << SYS_PGACR_OPA3SW_Pos);		  // PGA2����˲����裺1K


/* PGAģʽ�� */  // 3.67A*2 = 7.34
//	SYS->OPACR |= (0 << SYS_OPACR_OPA0ON_Pos) |
//								(1 << SYS_OPACR_OPA1ON_Pos) |
//								(0 << SYS_OPACR_OPA2ON_Pos) |
//								(0 << SYS_OPACR_OPA3ON_Pos) |
//								(1 << SYS_OPACR_VREFON_Pos) |
//								(1 << SYS_OPACR_OPA1MD_Pos) |		  // OPA1������PGAģʽ
//								(0 << SYS_OPACR_OPA2MD_Pos) |		  // OPA2������PGAģʽ
//								(0 << SYS_OPACR_OPA3MD_Pos);		  // OPA3������PGAģʽ
//								
// SYS->PGACR =  (0 << SYS_PGACR_VRTRIM_Pos) |		// VREF��ѹ��2V
//               (0 << SYS_PGACR_OPA1GN_Pos) |		// PGA1���淴�����裺10K
//							 (0 << SYS_PGACR_OPA2GN_Pos) |
//               (0 << SYS_PGACR_OPA3GN_Pos) |		// PGA2���淴�����裺10K
//               (0 << SYS_PGACR_OPA1SW_Pos) |		// PGA1����˲����裺1K
