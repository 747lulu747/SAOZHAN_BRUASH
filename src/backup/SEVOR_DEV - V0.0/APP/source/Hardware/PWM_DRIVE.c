...
void Init_PWM_Drive(void)
{
	...
	#if (PWM_Level_Mode == High_Level) // ������ƽ����
	{
  ...
  // 747 for test
//	Set_Phase_UPWM_HDuty(PWM_CLOCK_CYCLE * 0.1); // A   // testdata
//	Set_Phase_UPWM_LDuty(PWM_CLOCK_CYCLE * 0.1); // A   // testdata
//	Set_Phase_VPWM_HDuty(PWM_CLOCK_CYCLE * 0.3); // B		// testdata
//	Set_Phase_VPWM_LDuty(PWM_CLOCK_CYCLE * 0.3); // B   // testdata
//	Set_Phase_WPWM_HDuty(PWM_CLOCK_CYCLE * 0.5); // C		// testdata
//	Set_Phase_WPWM_LDuty(PWM_CLOCK_CYCLE * 0.5); // C   // testdata
//	MOE_Enable;
//	while(1);
