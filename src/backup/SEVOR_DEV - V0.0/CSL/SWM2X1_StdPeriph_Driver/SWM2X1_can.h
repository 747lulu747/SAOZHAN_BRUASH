#ifndef __SWM2X1_CAN_H__
#define __SWM2X1_CAN_H__
...
typedef struct {
  ...
  uint8_t  ArbitrLostIEn;    //��������ʧ�ٲñ�ɽ��շ�
  uint8_t  ErrPassiveIEn;    //����/���ʹ������ֵ�ﵽ127
} CAN_InitStructure;
...
#define CAN_INT_ERR_WARN  (0x01 << 2)    //TXERR/RXERR����ֵ�ﵽError Warning Limit
#define CAN_INT_ERR_PASS  (0x01 << 5)    //TXERR/RXERR����ֵ�ﵽ127
#define CAN_INT_WAKEUP    (0x01 << 4)


typedef struct {
  uint32_t id;    //��ϢID
  uint8_t  format;  //֡��ʽ��CAN_FRAME_STD��CAN_FRAME_EXT
  uint8_t  remote;  //��Ϣ�Ƿ�ΪԶ��֡
  uint8_t  size;    //���յ������ݸ���
  uint8_t  data[8];  //���յ�������
} CAN_RXMessage;
