#ifndef __SWM2X1_TIMR_H__
#define __SWM2X1_TIMR_H__

#define TIMR_MODE_TIMER    ((0 << 2) | 0)
#define TIMR_MODE_IC    ((1 << 2) | 0)  //���벶��
#define TIMR_MODE_OC    ((2 << 2) | 0)  //����Ƚ�
#define TIMR_MODE_COUNTER  ((0 << 2) | 2)  //����������


void TIMR_Init(TIMR_TypeDef * TIMRx, uint32_t mode, uint32_t prediv, uint32_t period, uint32_t int_en);  //��ʱ��/��������ʼ��
...
uint32_t TIMR_SetPrediv(TIMR_TypeDef * TIMRx, uint32_t prediv);  //����Ԥ��Ƶ
