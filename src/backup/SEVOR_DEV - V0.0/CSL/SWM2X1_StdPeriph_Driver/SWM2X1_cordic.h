...
* ���  ����:	CORDIC_Sin()
* ���  ˵��:	ʹ��CORDICģ�����sin
* ��    ��: uint32_    radian		Ҫ����sinֵ�ĽǶȣ��Ի���Ϊ��λ��ȡֵ��Χ0.01~1.56������Ҫ������ֵ����16384��Ϊ�������ô˺���
* ��    ��: ��
* ע������: ��Ҫ������ֵ����16384��Ϊ�������ô˺���
******************************************************************************************************************************************/
...
* ���  ˵��:	ȡ��CORDICģ��sin������
* ��    ��: ��
* ��    ��:     nt32_t		sin��������Result[15:14]��ʾ�������֣�Result[13:0]��ʾС������
* ע������: ��
******************************************************************************************************************************************/
...
* ���  ����:	CORDIC_Cos()
* ���  ˵��:	ʹ��CORDICģ�����cos
* ��    ��: uint32_    radian		Ҫ����cosֵ�ĽǶȣ��Ի���Ϊ��λ��ȡֵ��Χ0.01~1.56������Ҫ������ֵ����16384��Ϊ�������ô˺���
* ��    ��: ��
* ע������: ��Ҫ������ֵ����16384��Ϊ�������ô˺���
******************************************************************************************************************************************/
...
* ���  ˵��:	ȡ��CORDICģ��cos������
* ��    ��: ��
* ��    ��:     nt32_t		cos��������Result[15:14]��ʾ�������֣�Result[13:0]��ʾС������
* ע������: ��
******************************************************************************************************************************************/
...
* ���  ����:	CORDIC_Arctan()
* ���  ˵��:	ʹ��CORDICģ�����arctan
* ��    ��: uint32     input		ȡֵ��Χ0.05~10000������Ҫ�������16384��Ϊ�������ô˺���
* ��    ��: ��
* ע������: ��Ҫ��������ֵ����16384��Ϊ�������ô˺���
******************************************************************************************************************************************/
static __INLINE void CORDIC_Arctan(uint32_t input)
{
  ...
  {
    DIV_UDiv(32768*16384, input);
    while(DIV_Div_IsBusy());
    DIV_UDiv_Result(&div_quotient, &div_remainder);    
    // CORDIC->INPUT = 32768*16384/input;
    CORDIC->INPUT = div_quotient;
...
* ���  ˵��:	CORDICģ��arctan�����Ƿ����
* ��    ��: ��
* ��    ��:     nt32_t		0 arctan����δ���    1 arctan��������ɣ���ȡ��������
* ע������: 
******************************************************************************************************************************************/
...
* ���  ˵��:	ȡ��CORDICģ��arctan������
* ��    ��: ��
* ��    ��:     nt32_t		arctan��������Ϊ����ֵ��Result[15:14]��ʾ�������֣�Result[13:0]��ʾС������
* ע������: ��
******************************************************************************************************************************************/
...
* ���  ˵��:	ȡ��CORDICģ��˷�������
* ��    ��: ��
* ��    ��:     nt32_t		�˷���������Result[15:14]��ʾ�������֣�Result[13:0]��ʾС������
* ע������: ��
******************************************************************************************************************************************/
...
* ���  ˵��:	ȡ��CORDICģ�����������
* ��    ��: ��
* ��    ��:     nt32_t		������������Ϊ����ֵ��Result[15:14]��ʾ�������֣�Result[13:0]��ʾС������
* ע������: ��
******************************************************************************************************************************************/
