#ifndef __SWM211_PORT_H__
#define __SWM211_PORT_H__

void PORT_Init(PORT_TypeDef * PORTx, uint32_t n, uint32_t func, uint32_t digit_in_en);  //�˿����Ź���ѡ�����ȡֵ���£�
