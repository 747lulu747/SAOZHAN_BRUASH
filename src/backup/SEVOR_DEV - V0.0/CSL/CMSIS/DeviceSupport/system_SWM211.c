...
#define SYS_CLK   SYS_CLK_PLL //SYS_CLK_PLL


#define __HSI    (12000000UL)    //�����ڲ�ʱ��
#define __LSI    (   32000UL)    //�����ڲ�ʱ��
#define __HSE    (16000000UL)    //�����ⲿʱ��
 ...
 *****************************************************************************************/ 
#define SYS_PLL_SRC     SYS_CLK_12MHz //SYS_CLK_12MHz//SYS_CLK_XTAL//SYS_CLK_12MHz//SYS_CLK_XTAL  //��ȡֵSYS_CLK_12MHz��SYS_CLK_XTAL

#define PLL_IN_DIV    3   //3ʱΪ90Mhz��4ʱΪ67.5Mhz

#define PLL_FB_DIV    45
...
void switchToXTAL(uint32_t div8)
{
  ...
  PORTB->PULLD |=  ((1 << PIN11) | (1 << PIN12));    // �������裺0 ����   1 �ر�
